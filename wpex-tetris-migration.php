...
if (class_exists('WPEX_Tetris_Migration_Plugin')) {
    class WPEX_Tetris_Migration_Plugin {
        ...
        public function __construct() {
            ...
            add_action('init', [$this, 'skip_update_on_php8']);
            add_action('init', [$this, 'backup_logo_on_activation']);
        }
        ...
        public static function backup_logo_on_activation() {
            $logo = get_theme_mod('wpex_logo');
            if ($logo) {
                add_option('wpex_temp_logo', $logo);
            }
        }

        public function skip_update_on_php8() {
